...
The first principle of funcitonal programming: Pure functions. I have used fucntions for creating different behaviour of my classes. [pure funcitons for adding, finding or removing behaviour of books class](https://github.com/WinterASE2022-23/LibraryManagementSystem/blob/main/LibraryManagamentSystem-main/liberaryManagment/src/main/java/books.java?plain=1#L21-L49)
