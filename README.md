...
5. The use of pure functions in the code is [depicted here](https://github.com/WinterASE2022-23/LibraryManagementSystem/blob/main/LibraryManagamentSystem-main/FuncitonalProgramming/FuncitonalProgramming/src/main/java/BoardMathHelpers.java#L15-L62)
